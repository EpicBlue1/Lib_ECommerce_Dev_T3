  ...
  useEffect(
    () => {
      ...
      if (dropDownMode === "No Sort") {
        ...
        prod = filter.sort(
          (a, b) => a.ProductProperties[0].price - b.ProductProperties[0].price
        );
        ...
        prod = filter.sort(
          (a, b) => b.ProductProperties[0].price - a.ProductProperties[0].price
        );
      }
    ...
    setCard(
      props.AllProductData.filter(
        ...
        <ProductCard
          ...
          img={Lens.images[0]}
          name={Lens.name}
          price={Lens.ProductProperties[0].price}
          discount={Lens.ProductProperties[0].discount}
          brand={Lens.brand}
          id={Lens._id}
        />
      ))
      ...
      <Row className="AllProductConSec">
        <Col className="AllProductSubSec" md={{ span: 12 }}>
          <h1 className="txtGrayDark">
            <b>Camera Lenses & Accessories</b>
          </h1>
          <br></br>
          <p className="txtGrayDark">
            Browse our vast assortment of camera lenses, or indulge yourself and
            make your picture game easier with our exclusive range of
            accessories.
          </p>
        </Col>
        ...
        <Col className="FilterSec" md={{ span: 3 }}>
          <div className="FilterBlock">
            ...
            <div onClick={clearFilter} className="clearFilter-btn">
              Clear Filters
            </div>
          </div>
        </Col>
          ...
          <Row>
            <Col className="SortSec" md={6}>
              <p className="Sort_Num">
                ...
                {filterYes
                  ? data.filter((Product) => Product.brand === Product.brand)
                      .length
                  : data.filter((Product) => Product.brand === filterBy)
                      .length}{" "}
                Products
              </p>
            </Col>
